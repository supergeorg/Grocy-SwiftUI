...
struct SystemConfig: Codable {
    ...
    let defaultLocale, calendarFirstDayOfWeek: String
...
//// MARK: - SystemConfig
//struct SystemConfig: Codable {
//    let mode, demoDBSuffix, defaultLocale, currency: String
//    let calendarFirstDayOfWeek: String
//    let calendarShowWeekOfYear: Bool
//    let basePath, baseURL, stockBarcodeLookupPlugin: String
//    let disableURLRewriting: Bool
//    let entryPage: String
//    let disableAuth: Bool
//    let authClass, reverseProxyAuthHeader, ldapDomain, ldapAddress: String
...
//    let userPictureFileName: JSONNull?
//
//    enum CodingKeys: String, CodingKey {
//        case mode = "MODE"
//        case demoDBSuffix = "DEMO_DB_SUFFIX"
